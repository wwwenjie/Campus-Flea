# Generated by Django 2.1.4 on 2019-10-02 12:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tele', models.BigIntegerField(max_length=11, verbose_name='电话')),
                ('address', models.CharField(max_length=200, verbose_name='收货地址')),
                ('user_token', models.CharField(max_length=200, null=True, verbose_name='用户token')),
            ],
            options={
                'verbose_name': '用户表',
